...
def ali():
    ...
    # POST
    notify_url = "http://linzetong.club:8084/page2/"

    # GET
    return_url = "http://linzetong.club:8084/page2/"
...
def page2(request):
    ...
    if request.method == "POST":
        ...
        logger.info('post_dict', post_dict)
        # print(post_dict)
        """
        ...
        logger.info('POST验证', status)
        # print('POST验证', status)
        if status:
            logger.info("post_dict['stade_status']: ", post_dict['stade_status'])
            logger.info("post_dict['out_trade_no']: ", post_dict['out_trade_no'])
